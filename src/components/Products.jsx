...
const Products = () => {
  ...
  const getCategoryIcon = (category) => {
    switch (category) {
      case "Obat Keras":
        return <FaPills className="text-red-500" />;
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Produk-produk berkualitas tinggi yang telah terdaftar BPOM dan
          ...
          {products.map((product, index) => (
            ...
            >
              <div className="relative h-48 bg-gray-50 flex items-center justify-center p-4">
                ...
                />
                <div
                  className={`absolute top-4 right-4 px-3 py-1 rounded-full text-xs font-semibold border ${getCategoryColor(product.category)}`}
                >
                  {product.category}
                </div>
              </div>
              ...
              >
                <div className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <div
                      className={`inline-block mt-2 px-3 py-1 rounded-full text-sm font-semibold border ${getCategoryColor(selectedProduct.category)}`}
                    >
                  ...
                  <div className="space-y-6">
                    ...
                    {selectedProduct.indications && (
                      <div className="pt-4 border-t">
                        ...
                        <ul className="space-y-2">
                          {selectedProduct.indications.map(
                            (indication, idx) => (
                              <li key={idx} className="flex items-start">
                    ...
                    {selectedProduct.contra_indications && (
                      <div className="pt-4 border-t">
                        ...
                        <ul className="space-y-2">
                          {selectedProduct.contra_indications.map(
                            (contra, idx) => (
                              <li key={idx} className="flex items-start">
                    ...
                    {selectedProduct.sideEffects && (
                      <div className="pt-4 border-t">
                        ...
                        <ul className="space-y-2">
                          {selectedProduct.sideEffects.map(
                            (sideEffects, idx) => (
                              <li key={idx} className="flex items-start">
                                <FaExclamationCircle className="text-red-500 mt-1 mr-2 flex-shrink-0" />
                                <span className="text-gray-600">
                ...
                <div className="mt-6 p-4 bg-green-50 rounded-lg">
                  <p className="text-sm text-green-700">
                    <strong>Catatan:</strong> Semua produk kami terdaftar di
                    BPOM dan bersertifikat Halal. Verifikasi BPOM{" "}
                    <a

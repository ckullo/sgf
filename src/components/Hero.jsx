...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="pt-20 min-h-screen flex items-center bg-gradient-to-br from-green-50 via-white to-blue-50 overflow-hidden"
    >
          ...
          >
            ...
            <div className="space-y-3 mb-8">
              {highlights.map((item, index) => (
                ...
                >
                  <span className="text-green-600 mr-3 text-xl">
                    {item.icon}
                  </span>
